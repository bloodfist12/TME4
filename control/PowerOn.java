...
public class PowerOn extends Event implements Fixable {
    ...
    public void fix() { // turns Power on and zeros out error codes
        greenhouseControls.setStatus("poweron", true);
